...
import imglogin from '../../assets/fichier_produit_333.jpg'
const SignIn = () => {
  ...
  return (
    <div className='w-full h-screen flex items-start'>
      <div className='relative w-1/2 h-full flex flex-col'>
        <img className='h-full w-full ' src={imglogin} alt="" />
      ...
      <div className='w-1/2 h-full bg-[#FFFFFF] flex flex-col p-20 justify-between items-center '>
        ...
        <dialog id="my_modal_3" className="modal">
          ...
          <div className='w-full flex flex-col mt-8 pt-8'>
            <button className='w-full my-2 bg-mainColor rounded-3xl shadow p-4 text-center text-white flex items-center justify-center font-medium  transition-all duration-500 ease-in-out hover:bg-transparent hover:text-mainTextColor border-[1px] border-white hover:border-mainColor border-solid' onClick={handleSignIn}>Login</button>
          </div>
