...
import imglogin1 from '../../assets/fichier_produit_333.jpg'
...
const SignUp = () => {
  ...
  return (
    <div>
      ...
      <img className=' h-full w-full ' src={imglogin1} alt="" />
      </div>
    <div className='w-1/2 h-full bg-[#FFFFFF] flex flex-col  justify-between items-center '>
  ...
  />
        ...
        <div className='w-full flex flex-col mt-7 pt-7'>
          <button className='w-full my-1 bg-mainColor rounded-3xl shadow p-4 text-center text-white flex items-center justify-center font-medium  transition-all duration-500 ease-in-out hover:bg-transparent hover:text-mainTextColor border-[1px] border-white hover:border-mainColor border-solid ' onClick={handleSignUp}>Register</button>
        </div>
    </div>
    </div>
        </div>
